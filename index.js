document.getElementById("move-it").onclick = function () {
    location.href = "https://evealexis.github.io/move-it/"
};

document.getElementById("move-it-github").onclick = function () {
...
document.getElementById("to-do-github").onclick = function () {
    location.href = "https://github.com/evealexis/to-do"
};